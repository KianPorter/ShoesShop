...
async function main() {
    ...
    await db_1.default.query('DELETE FROM "CartItem"');
    await db_1.default.query('DELETE FROM "Product"');
    // Create products
    for (const product of products) {
        const productId = generateId();
        await db_1.default.query('INSERT INTO "Product" (id, name, description, price, "imageUrl", category, stock, featured) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [
            productId,
            product.name,
            product.description,
            product.price,
